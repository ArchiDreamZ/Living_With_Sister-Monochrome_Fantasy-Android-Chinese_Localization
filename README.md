# 妹相随：黑白世界的缤纷冒险-彼梦安卓版-中文精翻&彩绘更新整合项目
...
②**彩绘贴图**：该项目添加并更新了彩绘，会同时发布黑白版、普通彩绘版、幽夜彩绘优化版。而彩绘版本分为两种：普通彩绘版与幽夜彩绘优化版。
- 普通的“**彩绘版**”就是大伙已经广泛使用的那个彩绘版本，主要使用Daseson的[彩色模组(Color Mod)](https://f95zone.to/threads/imouto-life-fantasy-color-mod-v0-84-steam-daseson.153385/) 的彩绘贴图，并持续同步更新到最新模组版本；但我还为安卓版额外添加了国内画师“[一只马儿](https://www.pixiv.net/users/14933755/artworks)” ，以及国外画师Jhnnn的更多的彩绘贴图，作为Daseson彩色模组未绘制的夜袭部分等的补充。
- “**幽夜彩绘优化版**”使用“[幽夜的优化版彩色包](https://github.com/ArchiDreamZ/Living_With_Sister-Monochrome_Fantasy-Android-Chinese_Localization/tree/YouYe_Color_ImagePack#幽夜的优化版彩色包)”，它是由测试群群友“幽夜”在Daseson彩色模组与“一只马儿”彩色包的基础上，进行调色与重绘的新版彩色包。由于他的重绘非常精致，并与原版的简单线条风格区别过大，因此安卓彩绘版分成了两个彩绘版本来发布。
> 幽夜在2024年8月15日正式发布了彩色包1.0，发布于彼梦的安卓精翻测试群与Don的汉化群中。我帮助幽夜通过Github的[幽夜彩绘仓库分支](https://github.com/ArchiDreamZ/Living_With_Sister-Monochrome_Fantasy-Android-Chinese_Localization/tree/YouYe_Color_ImagePack)为彩色包进行了整理，修复了存在的问题，并将幽夜彩色包进行正式发布。后续还持续同步更新了Daseson彩色模组的新内容，并且添加了Jhnnn的更多彩绘贴图作为补充。该彩色包使用同样很广泛，很多人做的整合都使用了幽夜彩绘，以及安卓的巴图勇士DLC版与宁宁澄优化版也是，其中巴图勇士DLC版是将幽夜彩绘做了去色黑白处理来使用的。
...
在2025年10月7日，我终于完成了DLC版精翻汉化的第一个前瞻预览版，并在B站发布了视频。从此彼梦精翻版开始被更多人知晓，后续我也继续通过发布新视频来汇报项目成果。
...
*下载彩色包、模组、PC版等其他资源，请浏览上文的“[相关链接](https://github.com/ArchiDreamZ/Living_With_Sister-Monochrome_Fantasy-Android-Chinese_Localization?tab=readme-ov-file#相关链接)”章节*
...
在2026年8月30日的更新中，我为游戏添加了玩家需要的所有按键，包括：↑↓方向键、返回键、确认键、控制键、作弊键。并且通过编辑游戏代码，使所有场景的菜单都支持用方向键操作与返回键返回。

而且如今的作弊菜单也可以通过返回键来返回上一级，无需再像旧版作弊菜单那样退出重开作弊菜单。

并且所有按键默认隐藏，仅有按键“控制键”默认显示。需要玩家点击“控制键”才能手动开启显示其他按键，防止开局误触。
...
在24年7月6日的更新中，群友“空白”为该版本添加了非常自由丰富的内置作弊功能。与巴图原版作弊功能完全不同，该作弊尽可能的接近PC版所使用的CT表，添加了大量新的修改功能。而巴图DLC版也是使用了这套新作弊系统。
